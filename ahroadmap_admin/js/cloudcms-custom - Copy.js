...
function myFunction(){
	console.log("After function call: Filename to upload is " + $("#uploadFilename").val());
...
console.log("After name check: Filename to upload is " + $("#uploadFilename").val());
	branch.createNode({
		...
		console.log("After Node Creation: Filename to upload is " + $("#uploadFilename").val());
	...
	//alert(st);
		...
		console.log("Ajax: Filename to upload is " + $("#uploadFilename").val());
			$.ajax({
                    type: "POST",
